        ...
        while not self.shutdown_event.is_set():
            try:
                ...
                if text_to_speak == "<EOS>":
                    ...
                    # if "</think>" in text_to_speak:
                    #     # Nur Text nach </think> verwenden
                    #     idx = text_to_speak.find("</think>") + len("</think>")
                    #     text_to_speak = text_to_speak[idx:].strip()
                    #     if not text_to_speak:
                    #         continue  # Überspringen, falls kein Text nach </think> vorhanden ist
