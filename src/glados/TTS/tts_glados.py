...
class SpeechSynthesizer:
    ...
    MODEL_PATH = resource_path("models/TTS/de_DE-glados-high.onnx")
    PHONEME_TO_ID_PATH = resource_path("models/TTS/phoneme_to_id_german.pkl")
    ...
    def __init__(
        ...
        self.phonemizer = Phonemizer()  # Ohne config Parameter
    ...
    def _phonemizer(self, input_text: str) -> list[str]:
        ...
        phonemes = self.phonemizer.convert_to_phonemes([input_text], "de")
        #phonemes = phonemize_espeak(input_text, "de")
        #return [phonemes]
        return phonemes
